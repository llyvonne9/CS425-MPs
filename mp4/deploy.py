...
for i in range(1, 11):
    ...
    os.system('scp node.cpp test.cpp introducer.cpp maple_juice.h run.sh %s:/home/deploy/mp4' %(server))
    os.system('scp serverss.txt %s:/home/deploy/mp3/servers.txt' %(server))
